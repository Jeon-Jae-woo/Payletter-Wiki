    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100">
          <h2 className="text-base font-semibold text-gray-900" style={{ fontFamily: 'Pretendard, sans-serif' }}>
            새 일정 추가
          </h2>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="px-6 py-5 space-y-4" style={{ fontFamily: 'Pretendard, sans-serif' }}>
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-3 py-2 text-sm border rounded-lg outline-none transition-colors
                ${errors.title ? 'border-red-400 focus:border-red-500' : 'border-gray-200 focus:border-[#0054FF]'}
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-3 py-2 text-sm border rounded-lg outline-none transition-colors
                ${errors.date ? 'border-red-400 focus:border-red-500' : 'border-gray-200 focus:border-[#0054FF]'}`}
            />
          ...
          <div className="flex items-center gap-2">
            ...
            />
            <label htmlFor="allDay" className="text-sm text-gray-700 cursor-pointer select-none">
              하루 종일
            </label>
          </div>
            ...
            <div className="flex gap-3">
              <div className="flex-1">
                ...
                <input
                  ...
                  className="w-full px-3 py-2 text-sm border border-gray-200 rounded-lg outline-none focus:border-[#0054FF] transition-colors"
                />
              </div>
              <div className="flex-1">
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full px-3 py-2 text-sm border border-gray-200 rounded-lg outline-none focus:border-[#0054FF] transition-colors resize-none placeholder:text-gray-400"
            />
          </div>

          {/* Document Linking */}
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">관련 문서 연결</label>
            <div ref={searchRef} className="relative">
              <input
                ...
                className="w-full px-3 py-2 text-sm border border-gray-200 rounded-lg outline-none focus:border-[#0054FF] transition-colors placeholder:text-gray-400"
              />
              {isSearching && (
              ...
              {showDropdown && searchResults.length > 0 && (
                <div className="absolute top-full mt-1 left-0 right-0 z-10 bg-white border border-gray-200 rounded-lg shadow-lg overflow-hidden">
                  {searchResults.map((doc) => (
                    ...
                    >
                      ...
                      <span className="truncate text-gray-800">{doc.title || '제목 없음'}</span>
                    </button>
                  ))}
                </div>
              )}

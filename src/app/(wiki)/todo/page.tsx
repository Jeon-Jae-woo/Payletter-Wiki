  ...
  return (
    <div className="max-w-2xl mx-auto px-8 py-10">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">할 일</h1>
      </div>
          ...
          >
            ...
            {counts[t] > 0 && (
              <span className={`ml-1.5 text-xs px-1.5 py-0.5 rounded-full ${
                tab === t ? 'bg-[#0054FF] text-white' : 'bg-gray-100 dark:bg-gray-700 text-gray-500 dark:text-gray-400'
              }`}>
                {counts[t]}
              </span>
            )}
